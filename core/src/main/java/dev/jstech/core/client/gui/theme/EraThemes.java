...
public final class EraThemes {
    ...
    public static final EraTheme VINTAGE = new EraTheme(VINTAGE_COLOURS, new EraStyle(true, false, false, SMALL));

    /** Early-PC chrome: raised buttons, sunken display panels. */
    public static final EraTheme LEGACY = new EraTheme(LEGACY_COLOURS, new EraStyle(false, true, false, SMALL));
