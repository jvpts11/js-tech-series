...
public final class DiagnosticBag {
    ...
    public void error(final int line, final int column, final SigmaError error, final Object... arguments) {
    ...
    public void warning(final int line, final int column, final SigmaError error, final Object... arguments) {
    ...
    private void add(final Diagnostic.Severity severity, final int line, final int column,
                     final SigmaError error, final Object... arguments) {
