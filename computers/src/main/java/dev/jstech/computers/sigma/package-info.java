 ...
 */
/**
 * Σ#, the language a player writes programs in, and the compiler that reads it.
 *
 * <p>A program is written in a {@code .sgs} file on a computer's own disk and compiled to the
