...
public final class ArchiveVoice {
    ...
    private static final String[] BINARIES = {"awk", "basename", "bash", "bunzip2", "bzip2", "cat", "chgrp", "chmod",
        "chown", "chroot", "cmp", "cp", "cut", "date", "dd", "df", "diff", "dirname", "dmesg", "du", "echo", "ed",
        "egrep", "emerge", "env", "eselect", "expr", "false", "fgrep", "find", "free", "gawk", "getent", "grep",
        "groups", "gunzip", "gzip", "head", "hostname", "id", "install", "kill", "killall", "less", "ln", "locale",
        "login", "ls", "lsblk", "make", "md5sum", "mkdir", "mknod", "mktemp", "more", "mount", "mv", "nano", "nice",
        "nproc", "od", "passwd", "paste", "patch", "perl", "pgrep", "ping", "pkill", "portageq", "printf", "ps",
        "pwd", "python3.12", "readlink", "realpath", "rm", "rmdir", "rsync", "scc", "sed", "seq", "sh", "sha256sum",
        "sleep", "sort", "split", "stat", "strings", "su", "sync", "tail", "tar", "tee", "test", "top", "touch", "tr",
        "true", "tty", "umount", "uname", "uniq", "uptime", "vi", "wc", "wget", "which", "whoami", "xargs", "xz",
        "yes", "zcat"};

    private static final String[] LIBRARIES = {"ld-linux-x86-64.so.2", "libacl.so.1", "libattr.so.1", "libblkid.so.1",
        "libbz2.so.1", "libc.so.6", "libcap.so.2", "libcrypt.so.2", "libcrypto.so.3", "libdl.so.2", "libffi.so.8",
        "libgmp.so.10", "libkmod.so.2", "liblzma.so.5", "libm.so.6", "libmagic.so.1", "libmount.so.1",
        "libncursesw.so.6", "libpam.so.0", "libpcre2-8.so.0", "libpthread.so.0", "libreadline.so.8", "libresolv.so.2",
        "librt.so.1", "libssl.so.3", "libtinfo.so.6", "libudev.so.1", "libuuid.so.1", "libz.so.1", "libzstd.so.1"};

    private static final String[] PYTHON = {"abc", "argparse", "ast", "base64", "bisect", "calendar", "codecs",
        "configparser", "contextlib", "copy", "csv", "datetime", "decimal", "difflib", "enum", "fnmatch", "functools",
        "getopt", "gettext", "glob", "gzip", "hashlib", "heapq", "inspect", "io", "ipaddress", "keyword", "linecache",
        "locale", "lzma", "mimetypes", "numbers", "operator", "optparse", "os", "pathlib", "pickle", "platform",
        "posixpath", "pprint", "queue", "random", "reprlib", "selectors", "shlex", "shutil", "signal", "socket",
        "ssl", "stat", "string", "struct", "subprocess", "sysconfig", "tarfile", "tempfile", "textwrap", "threading",
        "tokenize", "traceback", "types", "typing", "uuid", "warnings", "weakref", "zipfile"};

    private static final String[] LOCALES = {"bg", "ca", "cs", "da", "de", "el", "en_GB", "eo", "es", "et", "fi",
        "fr", "ga", "gl", "he", "hr", "hu", "id", "it", "ja", "ko", "lt", "nb", "nl", "pl", "pt", "pt_BR", "ro", "ru",
