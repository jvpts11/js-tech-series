 ...
 * colors. Each desktop names its theme in its {@link DesktopLook}, so the shared {@link DesktopScreen} engine
 * renders a distinct look per desktop (Frames 95 grey/teal, Frames XP blue Luna, Frames 11 light centered).
 *
...
public record DesktopTheme(
    ...
    static final DesktopTheme WIN95 = new DesktopTheme(
    ...
    static final DesktopTheme XP = new DesktopTheme(
    ...
    static final DesktopTheme WIN11 = new DesktopTheme(
    ...
    static final DesktopTheme KDE = new DesktopTheme(
    ...
    static final DesktopTheme GNOME = new DesktopTheme(
    ...
    static final DesktopTheme CINNAMON = new DesktopTheme(
    ...
    static final DesktopTheme CDE_DEFAULT = cde(CdePalette.DEFAULT);
