...
| `computers/src/main/resources/assets/jsc/textures/block/speaker_{legacy,standard}_*.png` | The two speakers, the Legacy ToneWorks and the Standard Cobble: front, side, top and back | Faces of the speaker blocks | AI-generated | AI assistant, with a generator script, from photographs of real speakers |
...
| `computers/src/main/resources/assets/jsc/sounds/os/frames_95/startup.ogg` | A 1990s computer's start-up chime | Frames 95's chime, out of the monitors, when it reaches its desktop and when it shuts down | Third-party | Johnmode, CC0, https://freesound.org/people/Johnmode/sounds/818848/ |
| `computers/src/main/resources/assets/jsc/sounds/os/frames_95/error.ogg` | An interface's error pop | Frames 95's sound when it raises an error box | Third-party | SoundShelfStudio, Pixabay Content License, https://pixabay.com/sound-effects/film-special-effects-ui-error-pop-515668/ |
| `computers/src/main/resources/assets/jsc/sounds/os/frames_xp/startup.ogg` | A short instrumental start-up clip | Frames XP's chime, when it reaches its desktop and when it shuts down | Third-party | Lumineve, CC0, https://freesound.org/people/Lumineve/sounds/493700/ |
| `computers/src/main/resources/assets/jsc/sounds/os/frames_xp/error.ogg` | An error notification | Frames XP's sound when it raises an error box | Third-party | Universfield, Pixabay Content License, https://pixabay.com/sound-effects/film-special-effects-error-notification-09-206494/ |
| `computers/src/main/resources/assets/jsc/sounds/os/frames_11/startup.ogg` | A logging-in chime | Frames 11's chime, when it reaches its desktop and when it shuts down | Third-party | marlonnnnnn, CC0, https://freesound.org/people/marlonnnnnn/sounds/351880/ |
| `computers/src/main/resources/assets/jsc/sounds/os/frames_11/error.ogg` | An error sound | Frames 11's sound when it raises an error box | Third-party | Kastenfrosch, CC0, https://freesound.org/people/Kastenfrosch/sounds/521973/ |
