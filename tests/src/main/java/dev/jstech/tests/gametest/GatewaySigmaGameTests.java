...
/**
 * A Σ# program reaching the ComputerCraft side through a Gateway of its own machine: it finds the
 * Gateway the machine has, names it, and hears what a computer over there says.
 */
@GameTestHolder(JsTests.MODID)
@PrefixGameTestTemplate(false)
public final class GatewaySigmaGameTests {

    private GatewaySigmaGameTests() {
    }
