    ...
    public static void snapshotTag_bringsBackEveryKindItWroteDown(final GameTestHelper helper) {
        final Snapshot written = new Snapshot(4096,
                List.of(new Snapshot.IHeld.Text(0, 26, 3, false, "hello"),
                        ...
                        new Snapshot.IHeld.Tabled(6, 64, 9, false,
                                List.of(new Snapshot.IValue.I8(1), new Snapshot.IValue.Ref(0)),
                                List.of(new Snapshot.IValue.Ref(0), new Snapshot.IValue.Bool(true)),
                                List.of(new Snapshot.IValue.R8(0.5), new Snapshot.IValue.Ref(6)),
                                new Snapshot.IValue.Ref(6))),
                List.of(new Snapshot.ThreadShot(1, List.of(new Snapshot.FrameShot("Monitor", "OnTick",
                                ...
                                false, "PLAIN")), "NONE", 0L, new Snapshot.IValue.Nothing(),
                ...
                List.of(new Snapshot.FrameShot("Counter", "Counter", List.of(), 0,
                        new Snapshot.IValue.Nothing(), List.of(), List.of(), true, "PROTECT")),
